...
public interface NotificationService {
	...
	void cdoStaffDevelopment(StaffDevelopment staffDev);

	void supervisorStaffDevPending(StaffDevelopment staffDev);

	void copyOwnerStaffDevelopment(StaffDevelopment staffDev);

	void staffDevelopmentStatus(StaffDevelopment staffDev, String action);

	void hodStaffDevPending(StaffDevelopment staffDev);

	void committeeStaffDevPending(StaffDevelopment staffDev);

	void cdoStaffDevPending(StaffDevelopment staffDev);

	void ddgStaffDevPending(StaffDevelopment staffDev);
