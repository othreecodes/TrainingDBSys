...
public class NotificationServiceImpl implements NotificationService {
	...
	@Override
	public void cdoStaffDevelopment(StaffDevelopment staffDev) {
		HashMap<String, Object> data = new HashMap<String, Object>();
		data.put("staffDev", staffDev);
		data.put("approve", null);
		
		// find CFOs
		List<User> cdoList = this.userService.findByRole("ROLE_STAFFAPPLICATION");
		
		try {
			String message = templatingService.fillTemplate("staffdev", data);
			// mail sending
			if (cdoList != null && cdoList.size() > 0) {
				for (User cdo : cdoList) {
					LOG.info("Sending mail to CDO Staff: " + cdo.getFullName());
					sendEmail(true, cdo, "Staff Training and Development application request submitted", message);
				}
			}
		} catch (TemplatingException e) {
			LOG.error(e);
	...
	@Override
	public void supervisorStaffDevPending(StaffDevelopment staffDev) {
		HashMap<String, Object> data = new HashMap<String, Object>();
		data.put("staffDev", staffDev);
		data.put("approve", null);
		try {
			String message = templatingService.fillTemplate("staffdev-notify-supervisor", data);
			LOG.info("Sending mail to Supervisor: " + staffDev.getSupervisor().getFullName());
			sendEmail(true, staffDev.getSupervisor(), "Staff Training and Development application request waiting for your endorsement", message);
		} catch (TemplatingException e) {
			LOG.error(e);
			return;
		}
	...
	@Override
	public void copyOwnerStaffDevelopment(StaffDevelopment staffDev) {
		HashMap<String, Object> data = new HashMap<String, Object>();
		data.put("staffDev", staffDev);
		data.put("approve", null);
		try {
			String message = templatingService.fillTemplate("staffdev-copy", data);
			LOG.info("Sending mail to owner: " + staffDev.getOwner().getFullName());
			sendEmail(true, staffDev.getOwner(), "Copy of your Staff Training and Development application request", message);
		} catch (TemplatingException e) {
			LOG.error(e);
			return;
		}
	...
	@Override
	public void staffDevelopmentStatus(StaffDevelopment staffDev, String action) {
		HashMap<String, Object> data = new HashMap<String, Object>();
		data.put("staffDev", staffDev);
		data.put("approve", null);
		try {
			String message = templatingService.fillTemplate("staffdev-status", data);
			sendEmail(true, staffDev.getOwner(), "Staff Training and Development application: " + action, message);
		} catch (TemplatingException e) {
			LOG.error(e);
			return;
		}
	...
	@Override
	public void hodStaffDevPending(StaffDevelopment staffDev) {
		HashMap<String, Object> data = new HashMap<String, Object>();
		data.put("staffDev", staffDev);
		data.put("approve", null);
		try {
			String message = templatingService.fillTemplate("staffdev-notify", data);
			sendEmail(true, staffDev.getHod(), "Staff Training and Development application request waiting for your approval", message);
		} catch (TemplatingException e) {
			LOG.error(e);
			return;
		}
	...
	@Override
	public void committeeStaffDevPending(StaffDevelopment staffDev) {
		HashMap<String, Object> data = new HashMap<String, Object>();
		data.put("staffDev", staffDev);
		data.put("approve", null);
		...
		try {
			...
			if (cmtList != null && cmtList.size() > 0) {
				for (User cmt : cmtList) {
					sendEmail(true, cmt, "Staff Training and Development application request waiting for your approval", message);
				}
			}
		} catch (TemplatingException e) {
			LOG.error(e);
	...
	@Override
	public void cdoStaffDevPending(StaffDevelopment staffDev) {
		HashMap<String, Object> data = new HashMap<String, Object>();
		data.put("staffDev", staffDev);
		data.put("approve", null);
	...
	@Override
	public void ddgStaffDevPending(StaffDevelopment staffDev) {
		HashMap<String, Object> data = new HashMap<String, Object>();
		data.put("staffDev", staffDev);
		data.put("approve", null);
