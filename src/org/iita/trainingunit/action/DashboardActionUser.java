...
public class DashboardActionUser extends PersonProfileAction {
	...
	private PagedResult<StaffDevelopment> pagedAwaitingStaffDevApproval;
	...
	public PagedResult<StaffDevelopment> getPagedAwaitingStaffDevApproval() {
		return pagedAwaitingStaffDevApproval;
	}
	...
	public String execute() {
		...
		try {
			...
			this.pagedAwaitingStaffDevApproval = this.trainingUnitService.getAwaitingStaffDevApproval(this.getUser(), 0, 50);
