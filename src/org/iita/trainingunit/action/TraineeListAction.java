		...
		try {
			this.inputStream = this.exportService.exportToStream(
					new String[] { "Full name", "Nationality", "Gender", "DoB", "Start Date", "End Date", "Extension Date", "Duration", "Degree", 
							...
							"CRP", "Program", "Cost Center", "Keywords", "Research Topic", "IITA Supervisor", "Core Competencies", "Hubs", 
							"Address Contact", "Address City", "Address State/Province", "Address Country", "Phone Contacts", "Email Contacts" },
							 
					new String[] { "person.fullName", "person.country", "person.gender", "person.dob", "startDate", "EndDate", "extensionDate", "duration", 
							"degree", "location", "country", "university.title", "univSupervisors", "univSupervisorsEmail", "sponsor", "exportCrps", "program", "costCenters", "keywords", "researchTopic", "iitaSupervisors", "exportCoreCompetencies", "exportHubs",
							"person.addressContacts", "person.addressCity", "person.addressState", "person.addressCountry", "person.phoneContacts", "person.emailContacts" }, 
					trainees);
		} catch (IOException e) {
	...
	public String yearlyexport() {
		...
		try {
			this.inputStream = this.exportService.exportToStream(
					new String[] { "Full name", "Nationality", "Gender", "DoB", "Start Date", "End Date", "Extension Date", "Duration", "Degree", 
							"Research Location", "Research Country", "University Name", "Univ Supervisor", "Univ Supervisor Email", "Sponsor", 
							"CRP", "Cost Center", "Keywords", "Research Topic", "IITA Supervisor", "Core Competencies", "Hubs", 
							"Address Contact", "Address City", "Address State/Province", "Address Country", "Phone Contacts", "Email Contacts" },
							 
					new String[] { "person.fullName", "person.country", "person.gender", "person.dob", "startDate", "EndDate", "extensionDate", "duration", 
							"degree", "location", "country", "university.title", "univSupervisors", "univSupervisorsEmail", "sponsor", "exportCrps", "costCenters", "keywords", "researchTopic", "iitaSupervisors", "exportCoreCompetencies", "exportHubs",
							"person.addressContacts", "person.addressCity", "person.addressState", "person.addressCountry", "person.phoneContacts", "person.emailContacts"}, 
					trainees);
		} catch (IOException e) {
			addActionError(e.getMessage());
