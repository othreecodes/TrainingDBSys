...
public interface AdvancedTrainingSearchService {
	PagedResult<Trainee> searchTrainee(String sDate, String eDate, String operands, String origin, String text, String startDate, String endDate,
	...
	PagedResult<TrainingProgram> searchPrograms(String sDate, String eDate, String operands, String loc, String text, String startDate, String endDate,
	...
	PagedResult<Organization> searchOrg(String sDate, String eDate, String operands, String loc, String text, String startDate, String endDate, int startAt,
			int maxResults, boolean fullText) throws AdvancedTrainingSearchException;

	PagedResult<Trainer> searchTrainer(String sDate, String eDate, String operands, String origin, String text, String startDate, String endDate, int startAt,
			int maxResults, boolean fullText, String loc) throws AdvancedTrainingSearchException;

	List<Trainer> searchTrainer(String sDate, String eDate, String operands, String origin, String text, String startDate, String endDate, boolean fullText, String loc)
			throws AdvancedTrainingSearchException;

	List<Organization> searchOrg(String sDate, String eDate, String operands, String loc, String text, String startDate, String endDate, boolean fullText)
			throws AdvancedTrainingSearchException;

	List<Trainee> searchTrainee(String sDate, String eDate, String operands, String origin, String text, String startDate, String endDate,
	...
	List<TrainingProgram> searchPrograms(String sDate, String eDate, String operands, String loc, String text, String startDate, String endDate, boolean fullText, 
	...
	List<TrainingProposal> searchTrainingProposal(String sDate, String eDate, String operands, String loc, String text, String startDate, String endDate, boolean fullText, String type, boolean groupYearly, String cc)
	throws AdvancedTrainingSearchException;
	
	PagedResult<TrainingProposal> searchTrainingProposal(String sDate, String eDate, String operands, String loc, String text, String startDate, String endDate,
