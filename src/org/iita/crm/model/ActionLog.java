...
public class ActionLog extends VersionedEntity {
	...
	private StaffDevelopment staffdevelopment;
	...
	public enum ActionType {
		SUBMITTED, APPROVED, REJECTED, AMMEND, CANCELLED, FORWARD, SUPPORTED;
	}
	...
	/**
	 * Get the parent staffdevelopment record
	 * 
	 * @see application
	 * @return the application
	 */
