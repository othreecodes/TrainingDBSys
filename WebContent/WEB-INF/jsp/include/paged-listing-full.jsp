...
<div class="container">
	...
	<s:if test="pagedTrainee.pageSize > 0">
		...
		<s:include value="/WEB-INF/jsp/paging-advsearch.jsp">
			...
			<s:param name="sDate" value="sDate" />
			<s:param name="eDate" value="eDate" />			
			<s:param name="operands" value="operands" />
			<s:param name="origin" value="origin" />
			<s:param name="loc" value="loc" />	
		</s:include>
		<hgroup class="mb20">
