	...
	<table class="table table-striped">
		...
		<ol>
			<s:iterator value="groupUncompleted">
							...
							<s:if
									test="announcement.duration!=null && announcement.duration.length()>0"> - <s:property
										value="announcement.duration" />
								</s:if> <s:if test="otherAppDetails.startDate!=null">
...
<s:if
	test="nondegreeUncompleted.size()==0 && graduateUncompleted.size()==0 && groupUncompleted.size()==0 && otherUncompleted.size()==0 && individualUncompleted.size()==0 && staffDevUncompleted.size()==0 && sabbaticalUncompleted.size()==0 && inHouseUncompleted.size()==0 && internshipUncompleted.size()==0">
...
<s:if
	test="nongraduateApplication.size()==0 && graduateApplication.size()==0 && groupApplication.size()==0 && otherApplication.size()==0 && individualApplication.size()==0 && staffDevApplication.size()==0 && inHouseApplication.size()==0 && sabbaticalApplication.size()==0">
