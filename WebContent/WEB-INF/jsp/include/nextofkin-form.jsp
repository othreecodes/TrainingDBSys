...
<div class="row">
	...
	<div class="col-xs-6 col-md-6">
		...
		<s:select id="nextOfKinRelationship" cssClass="form-control" name="cdoBioData.nextOfKinRelationship" 
					list="#{'Father':'Father','Mother':'Mother','Parent':'Parent','Son':'Son','Daughter':'Daughter','Child':'Child','Husband':'Husband','Wife':'Wife','Brother':'Brother','Sister':'Sister','Sibling':'Sibling','Grandfather':'Grandfather','Grandmother':'Grandmother','Grandparents':'Grandparents','Grandson':'Grandson','Granddaughter':'Granddaughter','Grandchild':'Grandchild','Uncle':'Uncle','Aunt':'Aunt','Parent`s Sibling':'Parent`s Sibling','Nephew':'Nephew','Niece':'Niece','Sibling`s Child':'Sibling`s Child','Cousin':'Cousin','Aunt`s/Uncle`s Child':'Aunt`s/Uncle`s Child'}" 
					value="%{cdoBioData.nextOfKinRelationship}" headerKey="" headerValue="--Select--" />
	</div>
</div>