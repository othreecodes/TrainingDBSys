...
<body>
	...
	<div>
		<p>
			...
			<s:if test="iframeAll.size()==0">
				<p>No solicited IITA training announcements found. </p><p>Please check later.</p>
			</s:if>
		</p>
	</div>
	...
	<div class="form-group">
		<h4>For applicants searching for unsolicited training, kindly <a href="<s:url namespace='/application' action='usindex' />">apply here!</a> </h4>
	</div>
</body>
</html>