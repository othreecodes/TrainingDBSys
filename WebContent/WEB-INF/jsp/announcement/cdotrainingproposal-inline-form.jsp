				...
				<table class="inputform">
					...
					<tr>
						...
						<td><%--<FCK:editor
							...
							<s:textarea id="trainingProposal.projectInformation" name="trainingProposal.projectInformation" value="%{trainingProposal.projectInformation}" />
							<ckeditor:replace replace="trainingProposal.projectInformation" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
						</td>
					</tr>
					<tr>
						<td>CRP*:</td>
					...
					<tr>
						...
						<td><%--<FCK:editor instanceName="trainingProposal.activity" height="100">
							...
							<s:textarea id="trainingProposal.activity" name="trainingProposal.activity" value="%{trainingProposal.activity}" />
							<ckeditor:replace replace="trainingProposal.activity" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<s:textarea id="trainingProposal.introduction" name="trainingProposal.introduction" value="%{trainingProposal.introduction}" />
							<ckeditor:replace replace="trainingProposal.introduction" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<s:textarea id="trainingProposal.targetGroup" name="trainingProposal.targetGroup" value="%{trainingProposal.targetGroup}" />
							<ckeditor:replace replace="trainingProposal.targetGroup" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
						</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td>
							...
							<s:textarea id="trainingProposal.objective" name="trainingProposal.objective" value="%{trainingProposal.objective}" />
							<ckeditor:replace replace="trainingProposal.objective" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<s:textarea id="trainingProposal.learningMethod" name="trainingProposal.learningMethod" value="%{trainingProposal.learningMethod}" />
							<ckeditor:replace replace="trainingProposal.learningMethod" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<s:textarea id="trainingProposal.expectedOutcome" name="trainingProposal.expectedOutcome" value="%{trainingProposal.expectedOutcome}" />
							<ckeditor:replace replace="trainingProposal.expectedOutcome" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<s:textarea id="trainingProposal.courseContents" name="trainingProposal.courseContents" value="%{trainingProposal.courseContents}" />
							<ckeditor:replace replace="trainingProposal.courseContents" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
						</td>
					</tr>
					...
					<tr>
						...
						<td>
							...
							<s:textarea id="trainingProposal.accommodation" name="trainingProposal.accommodation" value="%{trainingProposal.accommodation}" />
							<ckeditor:replace replace="trainingProposal.accommodation" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
						</td>
					</tr>
					<tr>
						...
						<td>
							...
							<s:textarea id="trainingProposal.payment" name="trainingProposal.payment" value="%{trainingProposal.payment}" />
							<ckeditor:replace replace="trainingProposal.payment" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
						</td>
					</tr>
					<tr>
