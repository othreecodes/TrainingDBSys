					...
					<table class="inputform">
						...
						<s:else>
							...
							<tr>
								...
								<td><%--<FCK:editor
									...
									<s:textarea id="announcement.projectInformation" name="announcement.projectInformation" value="%{announcement.projectInformation}" />
									<ckeditor:replace replace="announcement.projectInformation" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
								</td>
							</tr>
							<tr>
								<td>CRP*:</td>
								<td><%--<FCK:editor instanceName="announcement.crp">
									...
									<s:textarea id="announcement.crp" name="announcement.crp" value="%{announcement.crp}" />
									<ckeditor:replace replace="announcement.crp" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td><%--<FCK:editor instanceName="announcement.activity">
									...
									<s:textarea id="announcement.activity" name="announcement.activity" value="%{announcement.activity}" />
									<ckeditor:replace replace="announcement.activity" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
								</td>
							</tr>
						</s:else>
						<tr>
						...
						<tr>
							...
							<td>
								...
								<s:textarea id="announcement.introduction" name="announcement.introduction" value="%{announcement.introduction}" />
								<ckeditor:replace replace="announcement.introduction" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
							</td>
						</tr>
						<tr>
							...
							<s:textarea id="announcement.targetGroup" name="announcement.targetGroup" value="%{announcement.targetGroup}" />
							<ckeditor:replace replace="announcement.targetGroup" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<s:textarea id="announcement.objective" name="announcement.objective" value="%{announcement.objective}" />
							<ckeditor:replace replace="announcement.objective" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
							</td>
						</tr>
						<tr>
							...
							<s:textarea id="announcement.learningMethod" name="announcement.learningMethod" value="%{announcement.learningMethod}" />
							<ckeditor:replace replace="announcement.learningMethod" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
							</td>
						</tr>
						<tr>
							...
							<s:textarea id="announcement.expectedOutcome" name="announcement.expectedOutcome" value="%{announcement.expectedOutcome}" />
							<ckeditor:replace replace="announcement.expectedOutcome" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
								</td>
						</tr>
						<tr>
							...
							<td>
								...
								<s:textarea id="announcement.courseContents" name="announcement.courseContents" value="%{announcement.courseContents}" />
							<ckeditor:replace replace="announcement.courseContents" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
							</td>
						</tr>		
						<tr>
							<td>Accommodation:</td>
							<td><%--<FCK:editor instanceName="announcement.accommodation" height="100">
								...
								<s:textarea id="announcement.accommodation" name="announcement.accommodation" value="%{announcement.accommodation}" />
							<ckeditor:replace replace="announcement.accommodation" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
							</td>
						</tr>
						<tr>
							...
							<td><%--<FCK:editor instanceName="announcement.payment" height="100">
								...
								<s:textarea id="announcement.payment" name="announcement.payment" value="%{announcement.payment}" />
							<ckeditor:replace replace="announcement.payment" basePath="${pageContext.servletContext.contextPath}/script/ckeditor/" />
							</td>
						</tr>
						<tr>
							<td>Keywords:</td>
