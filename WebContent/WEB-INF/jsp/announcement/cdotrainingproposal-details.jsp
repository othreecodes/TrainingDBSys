		...
		<s:if test="trainingProposal.id!=null">
			<td style="vertical-align: top;">
				...
				<iita:authorize ifAnyGranted="ROLE_USER,ROLE_CRM">
					...
					<s:if test="trainingProposal.status==@org.iita.trainingunit.announcements.model.TrainingProposal$STATUS@SUBMITTED || trainingProposal.status==@org.iita.trainingunit.announcements.model.TrainingProposal$STATUS@DRAFT || trainingProposal.status==@org.iita.trainingunit.announcements.model.TrainingProposal$STATUS@AMMEND">
