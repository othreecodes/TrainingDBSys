		...
		<tr>
			<td style="vertical-align: top; padding-right: 30px">
				<div class="alert alert-info">Before registering new training
					...
					already exists by searching for any related information.</div> <security:authorize
			...
			<td><s:if test="programs!=null && programs.size>0">
					<div class="panel panel-default">
						<div class="panel-heading">Last updated programs</div>
						<div class="panel-body">
							<ul class="list-group">
								<s:iterator value="programs">
									<li class="list-group-item"><s:include value="/WEB-INF/jsp/program/short.jsp" /></li>
								</s:iterator>
							</ul>
