...
<table style="width: 100%">
	...
	<col />
	<tr>
		<td rowspan="2" style="vertical-align: top; padding-right: 10px;"><a href="<s:url action="index" namespace="/admin" />" title="Go to dashboard of <fmt:message key="webapp.name" />"><img src="<c:url value='/img/train_50.png'/>" alt="IITA"
		...
		<td style="vertical-align: top; padding: 0;">
			...
			<div style="padding: 3px 6px; background-color: rgb(240, 240, 240);">
				...
				<h1 style="margin: 0px 0px 3px 0px; padding: 0px; font-size: 1.2em;">Administration: <fmt:message key="webapp.name" /></h1>
			</div>			
		</td>
	</tr>
	<tr>
