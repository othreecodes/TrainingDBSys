-- 14/10/2016
ALTER TABLE `training`.`TrainingProgram` ADD COLUMN `cdoStatus` VARCHAR(45) NULL AFTER `purpose`;
ALTER TABLE `training`.`Trainee` ADD COLUMN `cdoStatus` VARCHAR(45) NULL  AFTER `sponsor` ;
